-- hi,stop it please i just want to make scripts
...
local function queueTeleport()
	local scriptSource = [[
		loadstring(game:HttpGet("https://raw.githubusercontent.com/AWPexploits/Script-hub-skull/refs/heads/main/bgsi.lua"))()
	]]
	pcall(function()
